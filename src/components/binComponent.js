        ...
        <div className="forms">
            <div className="forms__body">
                ...
                <div className="forms__number">
                    <form>Номер телефону:<br/>
                        <input type="text" name="phone" id="fphone" defaultValue="+380"/>
                    </form>
                    <div className="forms__button" onClick={confirm}>Надіслати код</div>
                </div>
                ...
                <div className="forms__address">
                    <form>АДРЕСА:<br/>
                        ...
                        <input type="date" name="deliveryDate" src="/calendar.png" id="fdeliveryDate"/>
                    </form>
                    <p className="displayMessage"></p>
                </div>
                <div className="forms__send">
                    <div className="forms__buy" onClick={saveToDb}>Замовити</div>
                </div>
            </div>
